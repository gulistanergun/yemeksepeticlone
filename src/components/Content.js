              ...
              <div className='col-md-7 uyg-left-box'>
                  <div className='col-12'>
                    ...
                    <div className='d-flex'>
                      ...
                      <div className='col-8 ps-2 text-white info-text' > <p>
                      Yemek, hızlı market ya da çevredeki esnaflardan tüm ihtiyaçların dakikalar içinde kapında. Yemeksepeti’ni indir, sepetini oluşturup siparişini ver, online ya da kapıda dilediğin gibi öde.
                      </p>
                      </div>
                    </div>
                    <div className='row mt-4'>
                        <div className='col-md-3 app-box'>
                            <a href="https://apps.apple.com/us/app/yemeksepeti-food-grocery/id373034841?mt=8" target="_blank"><img src={appstore} alt="Appstore" /> </a>
                        </div>
                        <div className='col-md-3 app-box'>
                            <a href="https://play.google.com/store/apps/details?id=com.inovel.app.yemeksepeti" target="_blank"><img src={playstore} alt="PlayStore"/></a>
                        </div>
                        <div className='col-md-3 app-box'>
                            <a href="https://appgallery.huawei.com/app/C101836129" target="_blank"><img src={huawei} alt="Huawei"/></a>
                        </div>
                    </div>
                  </div>
